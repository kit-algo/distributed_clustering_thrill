...
jobs = [
  ["#{ENV['WORK']}/graphs/graph_50_10000_mu_0.4_16000000-sorted-preprocessed-*.bin",  00, 20, 1],
  ["#{ENV['WORK']}/graphs/graph_50_10000_mu_0.4_32000000-sorted-preprocessed-*.bin",  00, 29, 2],
  ["#{ENV['WORK']}/graphs/graph_50_10000_mu_0.4_64000000-sorted-preprocessed-*.bin",  01, 00, 4],
  ["#{ENV['WORK']}/graphs/graph_50_10000_mu_0.4_128000000-sorted-preprocessed-*.bin", 01, 00, 8],
  ["#{ENV['WORK']}/graphs/graph_50_10000_mu_0.4_256000000-sorted-preprocessed-*.bin", 01, 29, 16],
  ["#{ENV['WORK']}/graphs/graph_50_10000_mu_0.4_512000000-sorted-preprocessed-*.bin", 02, 00, 32],
]
